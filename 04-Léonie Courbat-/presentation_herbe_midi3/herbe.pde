...
class Herbe {
  ...
  //
  float colorControl = s1.getChannel(25);

  float controltaille = 5;
  ...
  void display() {
    ...
    // Contrôler ici avec le midi
    color remp = lerpColor(vertf, vertc, (y/colorControl)/10);
    color remp2 = lerpColor(orange, jaune, (y/colorControl)/10);
